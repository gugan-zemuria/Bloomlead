...
$('.portfolio-active').slick({
	...
	infinite: true,
    arrows: true,
	prevArrow: '<button type="button" class="slick-prev"><img src="img/bg/project-left.webp"/></button>',
	nextArrow: '<button type="button" class="slick-next"><img src="img/bg/project-right.webp"/></button>',
	speed: 1000,
	slidesToShow: 5,
	slidesToScroll: 1,
	responsive: [
